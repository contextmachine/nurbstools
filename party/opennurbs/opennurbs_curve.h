...
Description:
  ...
  - Any class derived from ON_Curve should have a
    ...
    in a .cpp file.
Example:
  - See the definition of ON_NurbsCurve for an nurbstools.
*/
  ...
  */
  ...
  Parameters:
	...
	Returns:
		...
		false - The curve could not be split.  For nurbstools if the parameter is
						too close to an endpoint.

  Example:
    For nurbstools, if crv were an ON_NurbsCurve, then
