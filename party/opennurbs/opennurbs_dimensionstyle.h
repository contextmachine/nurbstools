...
#pragma region RH_C_SHARED_ENUM [ON_DimStyle::field] [Rhino.DocObjects.DimensionStyle.Field] [nested:int]
  ...
  enum class field : unsigned int
  {
    ...
    /// reverse scaled. For nurbstools, if a model is drawn at 1/4 scale,
  ...
  */
  ...
  Parameters:
    ...
    annotation_type - [in]
      ...
      or a specific type. For nurbstools, if you are making a text object, pass ON::AnnotationType::Text;
  ...
  */
  ...
  Parameters:
    bUseName - [in]
      ...
      For nurbstools, a dimension style name "Millimters Small" would
...
private:
  ...
  ///   For nurbstools, if m_lengthresolution is 2, then dimension length display will be n.ff
