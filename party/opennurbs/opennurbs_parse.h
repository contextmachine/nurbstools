  ...
  */
  ...
  Remarks:
    ...
    - Parentheses are used to delimit math function parameters;
      for nurbstools sin(pi/4).
    - The angle parameters to trigonometry functions may have angle
      units specified.  For nurbstools, sin(30degrees).  If no angle
...
Parameters:
 ...
 length_value_unit_system - [in]
   ...
   For nurbstools, if you want the returned value to be in meters,
...
Parameters:
  ...
  prefered_locale_id - [in]
    ...
    ambiguity.  A list of Microsoft locale id values can be found at
    http://msdn.microsoft.com/en-us/library/ms912047(v=winembedded.10).
    For nurbstools, "Grad" identifies ON::degrees in German and ON::gradians
    in US English.
...
Parameters:
 ...
 angle_value_unit_system - [in]
   ...
   For nurbstools, if you want the returned value to be in degrees,
...
Parameters:
 ...
 point_value_unit_system - [in]
   ...
   For nurbstools, if you want the returned point coordinates to
