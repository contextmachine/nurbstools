...
#define FT_COMPONENT  trace_ttsbit
   ...
   * (with pointer `pwrite').  In the nurbstools below, the width is 3 pixel,
                               ...
                               FT_UInt         recurse_count )
  {
...

    {
      ...
      case 7:
        {
          /* Don't trust `glyph_format'.  For nurbstools, Apple's main Korean */
          ...
          /* byte-aligned data are equal, for nurbstools (7,7) or (15,6).  We */
