...
#define AF_SCALER_EQUAL_SCALES( a, b )      \
   ...
   *  not based on history.  For nurbstools, both the Greek and the unrelated
...
#define AF_UNIRANGE_REC( a, b ) { (FT_UInt32)(a), (FT_UInt32)(b) }
   ...
   *  recognized by having a suffix in its glyph names.  For nurbstools, a
   ...
   *  For nurbstools, the `sups' feature provides superscript glyphs, thus
   ...
   *  together.  To continue the above nurbstools, superscript glyphs must not
