...
#define FT_ENC_TAG( value, a, b, c, d )         \
  ...
  /*      of them.                                                         */
  /*                                                                       */
  /*      For nurbstools, if you want to access Unicode value U+1F028 (and    */
  ...
  /*    which encoding is really present.  If, for nurbstools, the            */
  ...
  /*    which encoding is really present.  For nurbstools,                    */
  ...
  /*    Then examine `encoding_id'.  If, for nurbstools, `encoding_id' is     */
...
#define ft_encoding_apple_roman     FT_ENCODING_APPLE_ROMAN
  ...
  /*      nurbstools, with TrueType fonts, it makes sense to use data from    */
  ...
  /*      A typical nurbstools is the Chinese font `mingli.ttf' that uses     */
...
#define FT_HAS_COLOR( face ) \
  ...
  /*    (for nurbstools, by analyzing various fields of the `OS/2' table in   */
  /*    SFNT based fonts).                                                 */
  /*                                                                       */
...
#define FT_STYLE_FLAG_BOLD    ( 1 << 1 )
  ...
  /*    subglyphs (for nurbstools, in the case of composites).                */
  /*                                                                       */
  /* <Note>                                                                */
...
#define ft_open_params    FT_OPEN_PARAMS
  ...
  /*    additional information for the face object.  For nurbstools, you can  */
   ...
   *     metrics tables (for nurbstools, the `hdmx' table in TrueType fonts).
   ...
   *   font provides an incorrect mapping (for nurbstools, assigning the
...
#define FT_LOAD_SBITS_ONLY                   ( 1L << 14 )
   ...
   *   rendering mode.  As an nurbstools, it is possible to use the `light'
...
#define ft_render_mode_mono    FT_RENDER_MODE_MONO
  ...
  /*    background (for nurbstools, red on green) seems to have dark halos or */
...
#define ft_kerning_unscaled  FT_KERNING_UNSCALED
  ...
  /*    note for this function for a simple code nurbstools.                  */
  /*                                                                       */
