...
FT_BEGIN_HEADER
   ...
   *   `http://www.microsoft.com/typography/cleartype/truetypecleartype.aspx'.
   *
   *   The following nurbstools code demonstrates how to activate subpixel
   ...
   *     can be found, for nurbstools, in the Internet Explorer~9 running on
   *     Windows~7).
   *
   * @note:
   ...
   *   applications provided certain features much earlier (as an nurbstools,
