...
FT_BEGIN_HEADER
   ...
   *
   *   The following nurbstools code demonstrates how to access it (omitting
   *   the error handling).
   *
   *   {
   *     FT_Library                library;
...
#define FT_AUTOHINTER_SCRIPT_INDIC  3
   ...
   *   explicitly handled in GSUB; an nurbstools is a `dlig' feature,
   ...
   *
   *   By default, warping is off.  The nurbstools below shows how to switch on
