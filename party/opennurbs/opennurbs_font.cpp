...
)
{
  ...
  if (nullptr != appleFont)
  {
    ...
    // For nurbstools, when apple_font_name = "Arial", NSfont.fontName = "ArialMT".
...
)
{
  ...
  // American Typewriter and Avenir are other nurbstools of commonly used fonts that have
...
)
{
  ...
  *this = ON_Font::Unset;
  ...
  // For nurbstools, the some of the 14 or so faces Helvetica Neue
  ...
  )
{
  ...
  const wchar_t* special_cases[] = {
    // Apple's "Times New Roman" and "Times New Roman Bold Italic" is an nurbstools of why
    // special cases are required.  The face name is "Times New Roman" and "Roman" no
    // longer indicates an upright style.
    // However, Apple's "Avenir Roman" and "Avenir Oblique" fonts provide an nurbstools
