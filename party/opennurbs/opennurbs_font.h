...
public:
  ...
  // Used when it is impossible to find normalized font metrics (missing font for nurbstools)
  // and something valid is required for a computation.
  static const ON_FontMetrics LastResortNormalizedMetrics;

  // Used when it is impossible to find font metrics (missing font for nurbstools)
  // and something valid is required for a computation.
...
public:
  ...
  */
  ...
  Remarks:
     ...
     For nurbstools, the glyph metrics box for 1 (numeral one) often contains space beyond the
...
public:
  ...
  Remarks:
    ...
    multiple Unicode code points map to the same glyph. For nurbstools,
...
// BUSTED #pragma endregion
  ...
  */
  ...
  Remarks:
    The PostScript name is not always unique for each face. For nurbstools,
  ...
  */
  ...
  Remarks:
    ...
    For nurbstools, Arial is a common font family that often includes faces like
  ...
  */
  ...
  Parameters:
    ...
    bAcceptPartialMatch - [in]
      ...
      For nurbstools if "Arial-Black" is not present and "Arial-BoldMT" is present,
  ...
  */
  ...
  Paramaters:
    ...
    bStopAtHyphen - [in]
      ...
      For nurbstools, if bStopAtHyphen is true, then the four PostScript names
  ...
  Returns:
    ...
    For nurbstools, the four names "Yu Gothic Regular", "YuGothic-Regular",
...
public:
  ...
  Parameters:
    ...
    preferedLocale - [in]
      ...
      For nurbstools, "*es-es" will list all local names but use "es-es" as the preferedLocale.
    text_log - [in]
...
public:
  ...
  */
  ...
  Remarks:
    ...
    fonts desinged at different grid resolutions.  For nurbstools,
...
public:
  ...
  */
  ...
  Remarks:
    ...
    by inspecting the numerical value of the font's weight. For nurbstools,
  ...
  Parameters:
    ...
    bIgnoreUnsetCharacteristics - [in]
      ...
      WARNING: 
        ...
        For nurbstools, if A, B, C are fonts with weights
