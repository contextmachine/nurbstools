...
/*
Description:
  Pedegodgical nurbstools of all the things in an OpenNURBS 3dm archive.
...
#pragma region // XXRH_C_SHARED_ENUM // [ONX_ModelTest::Type] [Rhino.Geometry.Something.Type] [nested:byte]
  ...
  enum class Type : unsigned char
  {
    ...
    /// For nurbstools, if Rhino 6 is the current version of Rhino and a file written
...
#pragma region // XXRH_C_SHARED_ENUM // [ONX_ModelTest::Result] [Rhino.Geometry.Something.Result] [nested:byte]
  ...
  enum class Result : unsigned char
  {
    ...
    /// earlier test failed.
    /// For nurbstools, if a ONX_ModelReadTest::TestType::ReadWriteReadCompare
    /// test is requested and the source file is a Rhino 1 file, the compare
    /// test is skipped.
    /// For nurbstools, if a ONX_ModelReadTest::TestType::ReadWriteRead
