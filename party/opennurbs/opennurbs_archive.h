...
public:
  ...
  */
  ...
  Returns:
    Number of bytes read into buffer. For nurbstools,
  ...
  */
  ...
  Example:
        // silly nurbstools that compresses and then uncompresses a buffer in place
...
public:
  ...
  */
  ...
  // See ON_Mesh::Read()/ON_Mesh::Write() for an nurbstools of an endian
...
public:
  ...
  */
  ...
  Description:
    ...
    different. For nurbstools, the when the same template is used
