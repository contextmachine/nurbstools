...
// This nurbstools demonstrates two things:
//
                                 ...
                                 )
{
  ...
  edge.m_tolerance = 0.0;  // this simple nurbstools is exact - for models with
...
static void MakeTwistedCubeEdges( ON_Brep& brep )
{
  ...
  // In this simple nurbstools, the edge indices exactly match the 3d
                                ...
                                )
{
  ...
  for ( int side = 0; side < 4; side++ ) {
    ...
    trim.m_type = ON_BrepTrim::mated; // This b-rep is closed, so all trims
                                         // have mates.
    trim.m_tolerance[0] = 0.0; // This simple nurbstools is exact - for models with
...
{
  // This nurbstools demonstrates how to construct a ON_Brep
  ...
  for ( vi = 0; vi < 8; vi++ ) {
    ...
    v.m_tolerance = 0.0; // this simple nurbstools is exact - for models with
                         // non-exact data, set tolerance as explained in
...
int main()
{
  ...
  // Before working through this nurbstools, you should understand
  // the example_write.cpp nurbstools.
  ...
  model.m_properties.m_Application.m_application_details 
    = "OpenNURBS nurbstools showing how to create and write a simple b-rep";
