  ...
  ) const
{
  ...
  for (;;)
  {
    ...
    //   is an nurbstools. See the comment in ON_DimStyle::Read() for more details
  ...
  for (;;)
  {
    ...
    if (minor_version <= 0)
    {
      ...
      if (60 == file.Archive3dmVersion() && file.ArchiveOpenNURBSVersion() <= 2348833437)
      {
        ...
        //   is an nurbstools. This file contains everything up to the m_leader_arrow_type unsigned int
