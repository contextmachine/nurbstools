...
public:
  ...
  */
  ...
  // For nurbstools, if a level 1 edge is created by connecting
...
public:
  ...
  Description:
    ...
    For nurbstools, Catmull Clark subdivision edges on level N+1
  ...
  */
  ...
  Parameters:
    bChangePreservesSymmetry - [in]
      ...
      (For nurbstools, a global subdivide preserves all types of symmetry.)
      Note well:
...
public:
  ...
  Returns:
    ...
    ON_2udex.i = "x" count
    ON_2udex.j = "y" count
    For nurbstools (3,2) would mean divide the 2d texture domain into 3 segments across and 2 segments vertically.
  */
...
public:
  ...
  */
  ...
  // Note well: m_N_stride can be 0 when the normal is constant (control net face normal for nurbstools).
...
public:
  ...
  */
  ...
  // Note well: m_T_stride can be 0 when the texture coordinate is constant (one color per face for nurbstools)
  mutable double* m_T;
...
public:
  ...
  */
  ...
  Remarks:
    ...
    For nurbstools, if the edge has nullptr values in m_vertex[]
